...
public enum CardErrorCode implements BaseCode {
    ...
    QUIZ_NOT_FOUND(HttpStatus.NOT_FOUND,
            "QUIZ404_1",
            "퀴즈를 찾을 수 없습니다."),
    TODAY_USERCARD_NOT_FOUND(HttpStatus.NOT_FOUND,
            "USERCARD404_1",
            "오늘 완료한 학습카드가 존재하지 않습니다."),
    CATEGORY_NOT_FOUND(HttpStatus.NOT_FOUND,
            "CATEGORY404_1",
            "존재하지 않는 카테고리입니다."),
    USERCATEGORY_NOT_FOUND(HttpStatus.NOT_FOUND,
            "USERCATEGORY404_1",
            "해당 카테고리를 유저가 학습한 기록이 존재하지 않습니다."),
    STUDY_ALREADY_FINISHED(HttpStatus.BAD_REQUEST,
            "STUDY400_1",
            "이미 완료한 학습입니다."),
